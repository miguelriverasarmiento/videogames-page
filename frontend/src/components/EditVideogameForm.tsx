  ...
  return (
    <div className="ml-5 mt-5 pb-5 md:w-1/2 mb-6 md:mb-0">
        <form onSubmit={handleSubmit}>
            ...
            <div>
                <button className="md:w-full bg-gray-900 text-white font-bold py-2 px-4 border-b-4 hover:border-b-2 border-gray-500 hover:border-gray-100 rounded-full cursor-pointer" type="submit">Actualizar Videojuego</button>
            </div>
        </form>
    </div>
  )
